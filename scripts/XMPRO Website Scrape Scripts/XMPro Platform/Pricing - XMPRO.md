...
The Pilot Program is priced at $3,000 per month for the software, with additional hosting packages available on XMPro’s cloud or dedicated Azure instances, ensuring a comprehensive and tailored evaluation experience.

$3,000/month*

*Hosting & Service rates charged seperately.

*XMPro Pilot software package is available for a maximum of 6 months. The pricing is for unlimited data streams, unlimited number of users, and unlimited connectors on desktop and mobile applications. The software pricing commences with the commencement of Phase 1 / Sprint 2 – Build and Scale.

The advantage of this approach is that the organization can verify the selected Use Case(s) with XMPro and provide confirmation of the number of data streams and details of the connectors.

XMPro standard pricing will apply after the pilot/MVP period based on XMPro’s pricelist.



## Build Your Own Capability Over Time

<img src="https://xmpro.com/wp-content/uploads/2020/05/Shaping-Curve-3.png" width="13821382" height="546546">

## Services and Solution Support

Our goal is to empower your subject matter experts (SME’s) to build their own applications using the XMPro platform.

For each customer, we create a skills transfer plan where we reduce the level of collaboration with XMPro, until your subject matter experts and IT team are self-sufficient on the platform. Our expert team of consultants and engineers can continue to provide extra capacity when required.
...
<img src="https://xmpro.com/wp-content/uploads/2021/05/XMPro-Services-Pricing-Matrix-v5.png" width="14621462" height="660660">

### XMPro Resources On Demand:

# Hosting

XMPro provides managed and hosted solutions on both Microsoft Azure and Amazon Web Services.

SaaS and dedicated hosting solution pricing available upon request.

## Additional Licensing Options

<img src="https://xmpro.com/wp-content/uploads/2021/05/OEM.png" width="192192" height="192192">

#### OEM & White Label

## Get a Pricing Estimate

Send a request below and one of our team members will reach out to discuss your use case requirements to provide you with a detailed pricing estimate.
